<?php
    ...
    $sql = "select product_type_id from products where product_name = '{$_POST['name']}'";
...
<!-- --------------------------------------------------------- -->
    ...
    <div class="small-container">
        ...
        <?php while ($row_1 = mysqli_fetch_array($result_1)){  ?>
                ...
                <div class="row">
                    <form action="./goods1.php" method="POST">
                        <div class="col-4">
                            ...
                            <!-- price -->
                            <p><?php echo $row_1['price'] ;?></p><br>
                        </div>
                        <!-- <input type="submit" name="sub" value="let see" > -->
                        <!-- <input type="submit" name="sub" value="click me"> -->
                        <button type="submit" name="sub" value="<?php echo $row_1['product_id'] ?>">click me</button>
                    </form>
                </div>
        <?php } ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-col-2">
                    <img src="../seacrh bar/img/OSONE_LOGO__1_-removebg-preview.png">
